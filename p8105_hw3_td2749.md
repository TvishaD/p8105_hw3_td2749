...
in tengths of mm (millimeters), ‘snow’ (numeric) depicts snowfall in mm,
‘snwd’ (numeric) depicts snowdepth in mm, and ‘tmax’ (character) and
‘tmin’ (character) depict the maximum and minimum temperature observed
on that day in tengths of degrees Celcius (°C).
